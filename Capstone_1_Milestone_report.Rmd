...
In this report the English database has used in this report but three other databases in German, Russian and Finnish are also available.

In this report has not used other information sources than these SwiftKey files, but eventual report and demo it is also possible.

## 3.2 File names and sizes, number of lines and words 

Data is in three files which are
...
There will be following tasks in this Capstore project in the future: 
...
- analysing and choosing prediction models
- making predictions
