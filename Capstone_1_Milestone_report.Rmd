...
rm(btext) # remove the object we don't need anymore
rm(ntext) # remove the object we don't need anymore
rm(ttext) # remove the object we don't need anymore
gc(verbose = TRUE) # garbage collection release memote
```
